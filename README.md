...
C'est cetalgorithme qui va faire appelle aux instances du réseau pour déterminer si une nouvelle instance peut se connecter au réseau et quel id on va lui attribuer. 
